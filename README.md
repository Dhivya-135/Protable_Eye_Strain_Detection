...
1. Open **Thonny**.
2. Open `eye_strain_detector.py`.
3. Make sure your webcam is connected.
4. Save the file.
5. Click **Run ▶**.
6. The camera starts automatically.
7. The small monitoring window appears at the bottom-right corner.
8. Click **CLOSE** to stop the camera and application.
